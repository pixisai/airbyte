...
from source_facebook_marketing.streams import (
    ...
    AdsInsightsCountryWithoutActionBreakdowns,
    AdsInsightsRegionWithoutActionBreakdowns,
    AdsInsightsDmaWithoutActionBreakdowns,
...
class SourceFacebookMarketing(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Type[Stream]]:
        ...
        streams = [
            ...
            AdsInsightsGender(page_size=config.page_size, **insights_args),
            AdsInsightsAge(page_size=config.page_size, **insights_args),
            ...
            AdsInsightsDevicePlatform(page_size=config.page_size, **insights_args),
            ...
            AdsInsightsCountryWithoutActionBreakdowns(page_size=config.page_size, **insights_args),
            AdsInsightsRegionWithoutActionBreakdowns(page_size=config.page_size, **insights_args),
            AdsInsightsDmaWithoutActionBreakdowns(page_size=config.page_size, **insights_args),
            AdsInsightsPublisherPlatform(page_size=config.page_size, **insights_args),
            Campaigns(
                api=api,
                account_ids=config.account_ids,
                start_date=config.start_date,
